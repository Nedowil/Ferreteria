                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    @forelse ($brands as $b)
                        <tr>
                            ...
                            <td class="px-4 py-2 text-gray-500">{{ $b->description }}</td>
                            <td class="px-4 py-2">{{ $b->active ? 'Si' : 'No' }}</td>
                            <td class="px-4 py-2 text-right space-x-2 whitespace-nowrap">
                                <a href="{{ route('admin.marcas.edit', $b) }}" class="text-indigo-600">Editar</a>
                                <form action="{{ route('admin.marcas.destroy', $b) }}" method="POST" class="inline"
