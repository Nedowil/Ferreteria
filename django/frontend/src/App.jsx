...
import NumericCaretOnFocus from "./components/NumericCaretOnFocus";
...
export default function App() {
  return (
    ...
    <Routes>
      ...
      <Route path="/conteo/historial" element={<Protected perm="inventario.historial"><StockCountHistory /></Protected>} />
