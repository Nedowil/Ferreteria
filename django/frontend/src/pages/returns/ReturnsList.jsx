            ...
            <Link key={r.id} to={`/devoluciones/${r.id}`} className="block p-4 active:bg-slate-50 dark:active:bg-slate-700">
              <div className="flex items-start justify-between gap-2">
                ...
                <div className="text-right shrink-0">
                  ...
                  <StatusPill label={r.status_display} />
                </div>
              </div>
          ...
          <tbody>
            {data.results.map((r) => (
              <tr key={r.id} className="border-t border-slate-100 dark:border-slate-700 hover:bg-slate-50/70 dark:hover:bg-slate-700 transition">
                <td className="px-4 py-2 pl-5 font-mono text-xs" style={{ borderLeft: "4px solid " + stripeColor(r.status_display) }}>{r.folio}</td>
                ...
                <td className="px-4 py-2"><StatusPill label={r.status_display} /></td>
