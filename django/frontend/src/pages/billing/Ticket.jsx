    ...
    <div className={mode === "carta" ? "max-w-4xl mx-auto" : "max-w-md mx-auto"}>
      <style>{`
        ...
        @media print {
          ...
          .ticket-paper, .ticket-paper * { color: #000 !important; font-weight: 700 !important;
            -webkit-text-stroke: 0.4px #000; text-shadow: 0 0 0.35px #000; }
          .ticket-paper .font-bold { font-weight: 900 !important; -webkit-text-stroke: 0.55px #000 !important; }
