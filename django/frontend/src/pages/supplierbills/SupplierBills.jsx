          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            {canFund && (
              <div className="flex gap-2">
                ...
                <button onClick={closeFund} className="border border-slate-300 dark:border-slate-600 text-slate-600 dark:text-slate-300 rounded-lg px-3 py-2 text-sm font-medium hover:bg-slate-50 dark:hover:bg-slate-700 transition">Cerrar fondo</button>
              </div>
            )}
          </div>
        ) : (
                ...
                {canEdit && (
                  <td className="px-4 py-2 text-right whitespace-nowrap">
                    <div className="inline-flex flex-wrap gap-1.5 justify-end">
                      <button onClick={() => edit(b)} title="Editar" className="inline-flex items-center gap-1 rounded-md px-2.5 py-1 text-xs font-medium shadow-sm transition bg-blue-600 hover:bg-blue-700 text-white">✏️ Editar</button>
                      <button onClick={() => remove(b)} title="Eliminar" className="inline-flex items-center gap-1 rounded-md px-2.5 py-1 text-xs font-medium shadow-sm transition bg-red-600 hover:bg-red-700 text-white">🗑️ Eliminar</button>
                    </div>
                  </td>
                )}
              </tr>
