...
class ProductListSerializer(serializers.ModelSerializer):
    ...
    def get_price_code(self, obj):
        from .labels import label_purchase_price, label_sale_price, price_code
        # Compra y venta en la MISMA medida: por CAJA si se vende por empaque;
        # si no, por unidad. Así el código coincide con lo que realmente venden.
        return price_code(label_purchase_price(obj), label_sale_price(obj))
