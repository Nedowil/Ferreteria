...
if not DEBUG:
    ...
    # HSTS: el navegador recuerda usar SIEMPRE HTTPS (1 año por defecto). El
    # sitio ya se sirve por HTTPS en Render, así que es seguro. Se puede
    # desactivar poniendo SECURE_HSTS_SECONDS=0 en las variables de entorno.
